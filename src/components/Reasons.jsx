...
export default function Reasons() {
  ...
  return (
      <section
          ...
          style={{
              background:
                  'linear-gradient(160deg, #0d0a1a 0%, #1e0b2c 50%, #0d0a1a 100%)',
          }}
      >
          {/* Background glow */}
          <div
          ...
          >
              <p className='text-blush-400 text-xs font-sans tracking-[0.3em] uppercase mb-3'>
                  One for every year.. and still not enough
              </p>
              <h2
                  id='reasons-heading'
                  className='font-serif text-4xl md:text-5xl font-bold gradient-text'
              >
                  27 Things I've Realised About You
              </h2>
              <div className='mt-4 mx-auto w-16 h-0.5 bg-gradient-to-r from-transparent via-blush-400 to-transparent' />
              <p className='font-serif italic text-blush-100/50 text-sm mt-4'>
                  Not reasons, just things I've noticed about you over the years
              </p>
          </motion.div>
                  ...
                  {!finished ? (
                      ...
                      >
                          ...
                          <p className='font-sans text-blush-100/70 text-sm leading-relaxed'>
                              These 27 are just the beginning of an ever-growing
                              list.
                          </p>
                      </motion.div>
                  )}
